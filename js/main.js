...
import { openSnake, leaveSnake, snakeStartGame, snakeRestartGame } from './snake.js';
...
window.__openSnake        = openSnake;
window.__leaveSnake       = leaveSnake;
window.__snakeStartGame   = snakeStartGame;
window.__snakeRestartGame = snakeRestartGame;
